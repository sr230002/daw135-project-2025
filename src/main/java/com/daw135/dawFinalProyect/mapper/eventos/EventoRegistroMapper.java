...
public interface EventoRegistroMapper {
    ...
    @Mapping(target = "estadoDesc", source = "estado.descripcion")
    @Mapping(target = "participanteNombre", source = "participanteId.nombre")
    @Mapping(target = "participanteCorreo", source = "participanteId.correo")
    @Mapping(target = "asistencia", source = "asistencia")
    @Mapping(target = "asistenciaConfirmada", source = "asistenciaConfirmada")
